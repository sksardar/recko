...
// class GraphMaker extends PureComponent{
//   render(){
//       const { renderGraph , type} = this.props;
//     return(
...
// // class RenderGraph extends PureComponent{
// //   render(){
...
//               type={type} 
//               renderGraph={ (props)=>{
//                 if(props.type === GraphTypes.CIRCULAR_PIE_CHART){
//                   return (<AnimatingCircularprogressBar {...props}/>);
//                 }
//                 return (<ChartGraph { ...props}/>)
//               }} 
//               />
//           </div>
//         </div>
