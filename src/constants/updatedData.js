...
const UpdatedData =[
  {
    ...
    [GraphTypes.ZOOMABLE_GRAPH]:{
      data:[
        { x: new Date(1983, 1, 1), y: 155 },
        { x: new Date(1989, 1, 1), y: 257 },
        { x: new Date(1994, 1, 1), y: 345 },
        { x: new Date(1998, 1, 1), y: 450 },
        { x: new Date(2003, 1, 1), y: 172 },
        { x: new Date(2006, 1, 1), y: 305 },
        { x: new Date(2012, 1, 1), y: 270 },
        { x: new Date(2016, 1, 1), y: 470 }
      ]
    },
    ...
    [GraphTypes.ZOOMABLE_GRAPH]:{
      data:[
        { x: new Date(1984, 1, 1), y: 155 },
        { x: new Date(1990, 1, 1), y: 257 },
